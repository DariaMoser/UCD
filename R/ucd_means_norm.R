#' Table of means of random sampling of age-at-death estimations of archaeological skeletal remains with assumed normal probability distribution
#'
...
#'
#' ucd_means_norm(df$min, df$max, age_breaks=seq(0,14,2))
#'
#'  (0,2]   (2,4]   (4,6]   (6,8]  (8,10] (10,12] (12,14]
#' 0.0000  0.1650  2.3505  0.9795  0.5725  0.8730  0.0595
#'



ucd_means_norm <- function(est_min, est_max, age_breaks, n_it=2000){
