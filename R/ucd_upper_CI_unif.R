#' Table of upper 95%-confidence bounds of random sampling of age-at-death estimations of archaeological skeletal remains with assumed uniform probability distribution
#'
...
#'
#' ucd_upper_CI_unif(df$min, df$max, age_breaks=seq(0,14,2))
#'
...
ucd_upper_CI_unif <- function(est_min, est_max,n_ind, age_breaks, n_it=2000){
