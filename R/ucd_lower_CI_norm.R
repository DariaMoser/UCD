#' Table of lower 95%-confidence bounds of random sampling of age-at-death estimations of archaeological skeletal remains with assumed normal probability distribution
#'
...
#'
#' ucd_lower_CI_norm(df$min, df$max, age_breaks=seq(0,14,2))
#'
...
ucd_lower_CI_norm <- function(est_min, est_max,n_ind, age_breaks, n_it=2000){
