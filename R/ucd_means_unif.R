#' Table of means of random sampling of age-at-death estimations of archaeological skeletal remains with assumed uniform probability distribution
#'
#' This function generates a table of mean counts by age group and iteration of randomly sampled iterations of exact
...
#'
#' ucd_means_unif(df$min, df$max, age_breaks=seq(0,14,2))
#'
#'  (0,2]   (2,4]   (4,6]   (6,8]  (8,10] (10,12] (12,14]
#' 0.0000  0.5645  1.8880  0.8865  0.8050  0.5010  0.3550
#'



ucd_means_unif <- function(est_min, est_max, age_breaks, n_it=2000){
  ...
  means_res <- apply(tab_res, 1, FUN=mean)
  means_res
}
